         ...
         while(bFlagEnd==false)
            ...
            if((s1==true)&&(s2==true)&&(bFlagDir1==true)){
                ...
                if(fTime>0)
                {
                    ...
                    switch(iCase){
                    case 49:
                        myNode.gaussianEffect(LIGHT3,GREEN,250,delayL3*1.7,delayL1,1);
                        myNode.gaussianEffect(LIGHT1,GREEN,250,lightDuration*1.7,delayL2,1);
                        myNode.gaussianEffect(LIGHT2,GREEN,250,lightDuration*1.7,delayL3,1);
                        myNode.gaussianEffect(LIGHT4,GREEN,250,lightDuration*1.7,delayL4,1); 
                    ...
                    case 50:
                        ...
                        myNode.digitalPulse(LIGHT1,GREEN,lightDuration*1.7,delayL2*1.7);
                        myNode.digitalPulse(LIGHT2,GREEN,lightDuration*1.7,delayL3*1.4);
                        myNode.digitalPulse(LIGHT4,GREEN,lightDuration*1.7,delayL4*1.3);
            ...
            if((s3==true)&&(s4==true)&&(bFlagDir2==true))
                ...
                switch(iCase){
                    case 49:
                        ...
                        myNode.gaussianEffect(LIGHT4,BLUE,250,delayL3*1.7,delayL1,1);
                        myNode.gaussianEffect(LIGHT2,BLUE,250,lightDuration*1.7,delayL2,1);
                        myNode.gaussianEffect(LIGHT1,BLUE,250,lightDuration*1.7,delayL3,1);
                        myNode.gaussianEffect(LIGHT3,BLUE,250,lightDuration*1.7,delayL4,1);
                        break; 
                    case 50:
                        myNode.digitalPulse(LIGHT4,BLUE,delayL3*1.7,delayL1*1.7);
                        myNode.digitalPulse(LIGHT2,BLUE,lightDuration*1.7,delayL2*1.7);
                        myNode.digitalPulse(LIGHT1,BLUE,lightDuration*1.7,delayL3*1.4);
                        myNode.digitalPulse(LIGHT3,BLUE,lightDuration*1.7,delayL4*1.3);
                        break;
                    }
